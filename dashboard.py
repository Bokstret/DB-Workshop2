...
import chart_studio
import re
chart_studio.tools.set_credentials_file(username='Bokstret', api_key='fdiuwJ11j7I1SB0WFYbS')
...
box_1= {
    ...
    'boxType': 'plot',
    'fileId': bar_id,
    'title': 'Запрос 1: Количество проектов c успешным либо проваленным сбором.'
}
